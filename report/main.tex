...
Note that we chose to use LSTM models instead of n-grams because long-range dependencies (longer than $n$) are difficult to learn. Furthermore, complexity of $n$-grams is of the scale $|V|^n$. In this case our vocabulary had size $43$. Therefore for $n=4$ we would have over 3 million possible sequences to store. 
...
\\ Tyler - Natural language feature extraction, AdaBoost, Naive Bayes, baseline results \\ Code can be found at: https://github.com/TylerYep/complex-text. TODO
