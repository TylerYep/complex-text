...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{../preprocess/avgsentlen.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{../preprocess/length.png}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{../preprocess/noun.png}
        \caption{}
        \label{n}
    \end{subfigure}
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=\textwidth]{../preprocess/unnormnoun.png}
        \caption{}
        \label{un}
    \end{subfigure}
