...
\begin{enumerate}
    ...
    \item \textbf{LSTM}
        ...
        \begin{itemize}
            \item $N\_LAYERS$, the number of LSTM layers
            \item $HIDDEN\_DIM$, the dimension of each LSTM layer, 
        \end{itemize}
...
\paragraph{Encoding}
Here we introduce two special characters '$<$', and '$>$' which are used to signify the beginning and the end of a text. Apart from these changes, the model architecure is equivalent to that in the previous section.
